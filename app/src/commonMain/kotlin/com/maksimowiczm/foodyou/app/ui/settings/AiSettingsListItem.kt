...
import foodyou.app.generated.resources.description_ai_settings
...
internal fun AiSettingsListItem(
    ...
    SettingsListItem(
        ...
        label = { Text(stringResource(Res.string.headline_ai_features)) },
        supportingContent = { Text(stringResource(Res.string.description_ai_settings)) },
        onClick = onClick,
        modifier = modifier,
        shape = shape,
        color = color,
